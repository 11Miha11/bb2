...
local PlayerExitHelper = {}

function PlayerExitHelper.savePlayerStats(player)
...
Players.PlayerRemoving:Connect(PlayerExitHelper.savePlayerStats)

return PlayerExitHelper